...
function AudioPicker(props) {
  ...
  function getVideoOptions() {
    const mimeTypes = ['audio/mpeg', 'audio/webm', 'audio/ogg', 'audio/wav'];
    ...
    <PickerBody>
      ...
      <nav class="quikpik-nav">
        ...
        <button
          type="button"
          class="quikpik-opt"
          classList={{ 'quikpik-opt-current': props.mode === 'takeaudio' }}
          onClick={() => props.setMode('takeaudio')}
        >
          <svg
            class="quikpik-opt-ico"
            fill="currentColor"
